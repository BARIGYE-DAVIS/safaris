...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="lg:flex">
        ...
        <aside id="sidebar" class="fixed top-0 left-0 h-full w-64 bg-indigo-800 text-white flex flex-col z-40 transform -translate-x-full transition-transform duration-300 lg:relative lg:translate-x-0 lg:static lg:block overflow-y-auto">
