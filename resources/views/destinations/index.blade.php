...
@section('title', 'Best Safari Destinations in East Africa | Uganda, Kenya, Tanzania & Rwanda Tours')
@section('meta_description', 'Explore the world\'s best safari destinations in East Africa. From Uganda gorilla trekking to Tanzania Serengeti, Kenya Masai Mara & Rwanda wildlife tours. Book your African safari holiday today.')
@section('meta_keywords', 'East Africa safari destinations, Uganda safari, Uganda safari destinations, Kenya safari, Tanzania safari, Rwanda gorilla trekking, Serengeti migration, Masai Mara, Bwindi Impenetrable Forest, African safari holidays, safari tours from USA, safari tours from UK, safari tours from Europe, best African safari, luxury safari Africa, budget safari Africa, family safari Africa, wildlife safari East Africa, national parks East Africa, safari packages 2024 2025, gorilla trekking Uganda, chimpanzee trekking, Big Five safari, Gorilla trekking in uganda, best time to visit Africa')
...
<div class="bg-white border-b border-gray-100 py-6 px-4">
    <div class="container mx-auto max-w-5xl text-center">
        ...
        <p class="text-gray-600 text-sm sm:text-base max-w-3xl mx-auto leading-relaxed">
            Trusted by international travellers from the <strong>USA, UK, Canada, Australia, Germany, France, Netherlands, Italy, Spain, Japan</strong> and beyond
            discover East Africa's finest wildlife parks, gorilla sanctuaries and Big Five reserves.
            Whether you're planning a <strong>luxury safari holiday</strong>, a <strong>budget-friendly group safari</strong>,
            or a <strong>family adventure in Africa</strong>, our destinations span Uganda, Kenya, Tanzania and Rwanda.
        </p>
    </div>
</div>
    ...
    <div class="container mx-auto max-w-4xl">
        <div class="text-center mb-10">
            <h2 id="faq-heading" class="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
                Frequently Asked Questions — East Africa Safari
            </h2>
...
<section class="bg-gradient-to-r from-green-600 via-teal-600 to-blue-600 text-white py-12 sm:py-16" aria-labelledby="cta-heading">
    <div class="container mx-auto px-4 text-center">
        <h2 id="cta-heading" class="text-3xl sm:text-4xl font-bold mb-3 sm:mb-4">
            Ready to Start Your East Africa Safari?
        </h2>
