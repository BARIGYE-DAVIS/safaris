...
<!-- Call to Action Section (Image Background) -->
<section class="relative py-16 lg:py-24 overflow-hidden">
    {{-- Background image --}}
    <div class="absolute inset-0">
        <img
            src="{{ asset('images/sun.webp') }}"
    ...
    <div class="relative max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        ...
        <p class="text-lg md:text-xl text-gray-100/90 mb-8 max-w-3xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ route('custom-tour-requests.create') }}"
               class="bg-white/95 text-gray-900 px-8 py-4 rounded-xl font-bold text-lg hover:bg-white transition-all duration-300 transform hover:scale-[1.02] shadow-lg">
                Plan Your Safari Now
            </a>

            <a href="https://wa.me/256752088768"
               class="bg-green-500 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-green-400 transition-all duration-300 flex items-center justify-center shadow-lg">
