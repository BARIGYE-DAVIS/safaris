...
{{-- ============================================================
     SEO META
     ============================================================ --}}
@section('title', 'Uganda Safari Tours & Gorilla Trekking 2026 | Calm Africa Safaris')
@section('meta_description', 'Plan your Uganda safari with Calm Africa Safaris. Gorilla trekking Bwindi from $1,300, chimp tracking Kibale, Big Five Queen Elizabeth & Murchison Falls. Expert local guides, small groups. Book today!')
@section('meta_keywords', 'Uganda safari, gorilla trekking Uganda, Bwindi gorilla trek, chimp tracking Kibale, Queen Elizabeth safari, Murchison Falls safari, East Africa safari tours, safari packages 2026')
...
<section class="hero-section relative w-full overflow-visible"
    ...
    <div class="hero-carousel absolute inset-0 overflow-hidden rounded-b-none">
        ...
        <div class="hero-slide absolute inset-0 w-full h-full opacity-0 transition-opacity duration-1000 ease-in-out"
            ...
            <div class="hero-bg-layer absolute inset-0"
                 style="background-image:linear-gradient(rgba(0,0,0,.45),rgba(0,0,0,.45)),url('{{ asset('images/sun.webp') }}');
                        background-size:cover;
                        background-position:center;
                        background-attachment:fixed;">
            </div>
    ...
    <div class="hero-text-wrap absolute inset-0 flex flex-col items-center justify-center pb-32 sm:pb-36 px-4 sm:px-6 lg:px-8 z-10">
        <div class="text-center text-white w-full max-w-xs sm:max-w-lg md:max-w-2xl lg:max-w-4xl xl:max-w-5xl">
            <h1 class="hero-h1 text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 sm:mb-6 leading-tight opacity-0">
                Uganda Safari Tours &amp; Gorilla Trekking 2026
            </h1>
    ...
    {{-- ── OVERLAP CARD ── --}}
    <div class="overlap-card absolute bottom-0 left-1/2 -translate-x-1/2 w-full max-w-5xl px-4 sm:px-6 z-20"
...
<section id="introduction" class="py-12 sm:py-16 lg:py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-base sm:text-lg text-gray-700 max-w-4xl mx-auto mb-6 leading-relaxed">
            Calm Africa Safaris is Uganda's trusted <strong>gorilla trekking</strong> and wildlife safari operator,
            offering <strong>budget, midrange and luxury safari packages</strong> across
            <strong>Bwindi Impenetrable Forest</strong>, <strong>Kibale National Park</strong>,
            <strong>Queen Elizabeth National Park</strong>, <strong>Murchison Falls</strong> and
            <strong>Kidepo Valley</strong>. We also operate <strong>gorilla trekking in Rwanda</strong>,
            Kenya safaris and Tanzania wildlife tours. All packages include expert local guides,
            accommodation, meals and airport transfers. Gorilla permits start from
            <strong>$800 per person</strong> packages from <strong>$1,300 per person</strong>.
        </p>
