...
<?php $__env->startSection('title', 'Contact Us - Get in Touch with Calm Africa Safaris'); ?>
<?php $__env->startSection('meta_description', 'Contact Calm Africa Safaris for your dream safari adventure. Get expert advice, custom quotes, and personalized service. Call, email, or visit us today!'); ?>
<?php $__env->startSection('meta_keywords', 'contact Calm Africa Safaris, safari contact, tour booking contact, East Africa safari contact, Tanzania safari contact, Kenya safari contact, Uganda safari contact, safari inquiry, custom safari quote, tour operator contact, safari expert, travel consultation'); ?>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 mb-2">Send us your detailed safari requirements</p>
                                    <a href="mailto:info@calmafricasafaris.com" class="text-blue-600 font-medium hover:text-blue-700">
                                        info@calmafricasafaris.com
                                    </a>
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="text-lg text-gray-600">
                    Quick answers to common questions about safari bookings and our services
                </p>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                    <button class="faq-toggle w-full text-left p-6 flex items-center justify-between focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 rounded-lg">
                        <h3 class="text-lg font-semibold text-gray-900">How far in advance should I book my safari?</h3>
                    ...
                    <div class="faq-content hidden px-6 pb-6">
                        <p class="text-gray-600">
                            We recommend booking 3-6 months in advance, especially for peak seasons (June-October and December-January). 
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                    <button class="faq-toggle w-full text-left p-6 flex items-center justify-between focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 rounded-lg">
                        <h3 class="text-lg font-semibold text-gray-900">What's included in your safari packages?</h3>
                        <svg class="faq-icon w-5 h-5 text-gray-500 transform transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </button>
                    <div class="faq-content hidden px-6 pb-6">
                        <p class="text-gray-600">
                            Most packages include accommodation, all meals, game drives, park fees, professional guide, 
                            and transportation. International flights, visas, travel insurance, and personal expenses are typically not included.
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                    <button class="faq-toggle w-full text-left p-6 flex items-center justify-between focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 rounded-lg">
                        <h3 class="text-lg font-semibold text-gray-900">Can you customize a safari for our specific needs?</h3>
                        <svg class="faq-icon w-5 h-5 text-gray-500 transform transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </button>
                    <div class="faq-content hidden px-6 pb-6">
                        <p class="text-gray-600">
                            Absolutely! We specialize in creating custom safari experiences tailored to your preferences, budget, 
                            group size, and interests. Simply contact us with your requirements and we'll design the perfect itinerary.
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                    <button class="faq-toggle w-full text-left p-6 flex items-center justify-between focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 rounded-lg">
                        <h3 class="text-lg font-semibold text-gray-900">What's your cancellation policy?</h3>
                        <svg class="faq-icon w-5 h-5 text-gray-500 transform transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </button>
                    <div class="faq-content hidden px-6 pb-6">
                        <p class="text-gray-600">
                            Our cancellation policy varies by package and booking date. Generally, cancellations 60+ days before departure 
                            incur minimal fees, while last-minute cancellations may have higher penalties. Full details are provided with your booking.
                        </p>
                    </div>
                </div>
            </div>
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\safaris\resources\views/contact/index.blade.php ENDPATH**/ ?>