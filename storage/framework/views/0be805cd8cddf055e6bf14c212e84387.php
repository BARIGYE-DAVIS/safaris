            ...
            <div id="filter-form-wrap" class="hidden md:block">
                <form id="filter-form" method="GET" action="<?php echo e(route('tours.index')); ?>#tour-filters"
                    ...
                    <div class="w-full md:flex-1 md:min-w-[120px]">
                        ...
                        <select name="<?php echo e($f['name']); ?>" class="tour-filter w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 bg-white">
                    ...
                    <div class="w-full md:flex-1 md:min-w-[110px]">
                        ...
                        <select name="duration" class="tour-filter w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 bg-white">
                            ...
                            <?php $__currentLoopData = $availableDurations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($d); ?>" <?php echo e(request('duration')==$d ? 'selected' : ''); ?>>
                                    <?php echo e($d); ?> <?php echo e($d==1 ? 'Day' : 'Days'); ?>
                            ...
                            <?php if($priceRanges['min'] > 0 && $priceRanges['max'] > 0): ?>
                                ...
                                <?php $__currentLoopData = $ranges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>[$mn,$mx]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>" <?php echo e(request('price_range')==$key ? 'selected' : ''); ?>>
                                        $<?php echo e(number_format($mn)); ?> &ndash; $<?php echo e(number_format($mx)); ?>
                    ...
                    <div class="flex gap-2 md:hidden">
                        ...
                        <?php if(request()->hasAny(['category','type','destination','duration','price_range','sort'])): ?>
                            <a href="<?php echo e(route('tours.index')); ?>#tour-filters" class="px-4 py-2 bg-gray-500 hover:bg-gray-600 text-white rounded-lg text-sm font-medium">Clear</a>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="mt-3 flex flex-wrap gap-2 items-center">
                        ...
                        <?php if(request('category')): ?>
                            <span class="inline-flex items-center bg-green-100 text-green-800 px-2 py-0.5 rounded-full text-xs">
                                ...
                                <a href="<?php echo e(request()->fullUrlWithQuery(['category'=>null])); ?>#tour-filters" class="ml-1 font-bold">&times;</a>
                            </span>
                        <?php endif; ?>
                        <?php if(request('type')): ?>
                            <span class="inline-flex items-center bg-blue-100 text-blue-800 px-2 py-0.5 rounded-full text-xs">
                                ...
                                <a href="<?php echo e(request()->fullUrlWithQuery(['type'=>null])); ?>#tour-filters" class="ml-1 font-bold">&times;</a>
                            </span>
                        <?php endif; ?>
                        <?php if(request('destination')): ?>
                            <span class="inline-flex items-center bg-purple-100 text-purple-800 px-2 py-0.5 rounded-full text-xs">
                                ...
                                <a href="<?php echo e(request()->fullUrlWithQuery(['destination'=>null])); ?>#tour-filters" class="ml-1 font-bold">&times;</a>
                            </span>
                        <?php endif; ?>
                        <?php if(request('duration')): ?>
                            <span class="inline-flex items-center bg-orange-100 text-orange-800 px-2 py-0.5 rounded-full text-xs">
                                ...
                                <a href="<?php echo e(request()->fullUrlWithQuery(['duration'=>null])); ?>#tour-filters" class="ml-1 font-bold">&times;</a>
                            </span>
                        <?php endif; ?>
                        <?php if(request('price_range')): ?>
                            <span class="inline-flex items-center bg-pink-100 text-pink-800 px-2 py-0.5 rounded-full text-xs">
                                ...
                                <a href="<?php echo e(request()->fullUrlWithQuery(['price_range'=>null])); ?>#tour-filters" class="ml-1 font-bold">&times;</a>
                            </span>
                        <?php endif; ?>
                        <?php if(request('sort')): ?>
                            <span class="inline-flex items-center bg-gray-100 text-gray-800 px-2 py-0.5 rounded-full text-xs">
                                ...
                                <a href="<?php echo e(request()->fullUrlWithQuery(['sort'=>null])); ?>#tour-filters" class="ml-1 font-bold">&times;</a>
                            </span>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
            ...
            <div id="grid-container" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
                ...
                <article class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 group flex flex-col"
                    ...
                    <div class="relative h-44 sm:h-52 md:h-64 overflow-hidden shrink-0">
                        ...
                        <?php endif; ?>
                        <span class="absolute top-2 left-2 bg-green-600 text-white px-2 py-0.5 rounded-full text-xs font-semibold"><?php echo e($tour->category ?? 'Safari'); ?></span>
                        ...
                        <?php if($tour->type): ?>
                            <span class="absolute bottom-2 left-2 bg-blue-600 text-white px-2 py-0.5 rounded-full text-xs font-semibold"><?php echo e($tour->type); ?></span>
                        <?php endif; ?>
                    </div>
                    <div class="p-3 sm:p-4 md:p-6 flex flex-col flex-1">
                        ...
                        <div class="flex items-center mb-3 text-xs text-gray-500">
                            ...
                            <span class="line-clamp-1" itemprop="touristType"><?php echo e($tour->destinations ?: 'Uganda, East Africa'); ?></span>
                        </div>
                        ...
                        <div class="flex gap-2 mt-auto">
                            ...
                            <button onclick="quickBook('<?php echo e($tour->slug); ?>')"
                                    ...
                                    title="Quick Book <?php echo e($tour->title); ?>">
                ...
                <div class="flex gap-3 overflow-x-auto pb-4 snap-x snap-mandatory scrollbar-hide -mx-4 px-4">
                    ...
                    <div class="flex-shrink-0 w-64 snap-start bg-white rounded-xl shadow-lg overflow-hidden">
                        <div class="relative h-36 overflow-hidden">
                            ...
                            <?php endif; ?>
                            <span class="absolute top-2 left-2 bg-green-600 text-white px-2 py-0.5 rounded text-xs"><?php echo e($tour->category ?? 'Safari'); ?></span>
                        </div>
                        <div class="p-3">
                            <h3 class="text-sm font-bold text-gray-900 mb-1 line-clamp-1"><?php echo e($tour->title); ?></h3>
                            <div class="flex items-center mb-2 text-xs text-gray-500">
                                ...
                                <span class="line-clamp-1"><?php echo e($tour->destinations ?: 'Uganda, East Africa'); ?></span>
                            </div>
                            <div class="flex items-center justify-between mb-2">
                                <?php if($tour->prices && $tour->prices->count() > 0): ?>
                                    <?php $minPrice = $tour->prices->min('price'); ?>
                                    <span class="text-sm font-bold text-green-600">$<?php echo e(number_format($minPrice)); ?><span class="text-xs text-gray-400 font-normal"> /pp</span></span>
                                <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\safaris\resources\views/tours/index.blade.php ENDPATH**/ ?>