                            ...
                            <div class="p-4 sm:p-5 flex flex-col" style="min-height:200px;">
                                ...
                                <div class="flex items-center mb-3 text-xs text-gray-500">
                                    ...
                                    <span class="line-clamp-1">
                                        <?php echo e(is_array($tour->destinations) ? implode(', ', $tour->destinations_array) : ($tour->destinations ?: 'East Africa')); ?>
                                ...
                                <div class="flex items-center justify-between mb-4">
                                    <div>
                                        <?php if($tour->price && $tour->price > 0): ?>
                                            <div class="flex items-baseline gap-1">
                                                <span class="text-xl font-bold text-green-600"><?php echo e($tour->formatted_price); ?></span>
                                                <span class="text-gray-400 text-xs">/ person</span>
                                            </div>
                                            <?php if($tour->prices && $tour->prices->count() > 1): ?>
                                        ...
                                        <?php elseif($tour->prices && $tour->prices->count() > 0): ?>
                                            ...
                                            <div class="flex items-baseline gap-1">
                                                <span class="text-xl font-bold text-green-600">$<?php echo e(number_format($minPrice)); ?></span>
                                                <span class="text-gray-400 text-xs">/ person</span>
                                            </div>
                                            <p class="text-xs text-gray-400">Starting from</p>
                                        <?php else: ?>
                                    ...
                                    <div class="flex items-center gap-1">
                                        ...
                                        <span class="text-xs text-gray-600 font-medium"><?php echo e($tour->average_rating); ?></span>
                                    </div>
                                </div>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\safaris\resources\views/partials/tour-list.blade.php ENDPATH**/ ?>