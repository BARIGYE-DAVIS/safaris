        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="space-y-4">
                <div class="flex items-center space-x-2">
                    <img class="h-8 w-auto" src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo">
                ...
                <div class="flex space-x-4">
                    <!-- Facebook -->
                    <a href="https://facebook.com/safaritours" target="_blank" rel="noopener noreferrer" 
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-3">
                    ...
                    <li>
                        <a href="<?php echo e(route('about')); ?>" class="text-gray-300 hover:text-white transition-colors duration-300 text-sm flex items-center group">
                            <svg class="h-4 w-4 mr-2 text-green-400 group-hover:text-green-300 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                            About Us
                    ...
                    <li>
                        <a href="<?php echo e(route('tourist-information')); ?>" class="text-gray-300 hover:text-white transition-colors duration-300 text-sm flex items-center group">
                            <svg class="h-4 w-4 mr-2 text-green-400 group-hover:text-green-300 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                            Tourist Information
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
                <div class="text-gray-400 text-sm text-center lg:text-left">
                    <p>&copy; <?php echo e(date('Y')); ?> Calm Africa Safaris. All rights reserved. | Designed with ❤️ for adventurers</p>
                </div>
                <div class="flex flex-wrap justify-center lg:justify-end gap-x-6 gap-y-2 text-sm">
                    ...
                    <a href="<?php echo e(route('cookie-policy')); ?>"     class="text-gray-400 hover:text-white transition-colors duration-300 hidden">Cookie Policy</a>
...
</script><?php /**PATH C:\xampp\htdocs\safaris\resources\views/components/footer.blade.php ENDPATH**/ ?>