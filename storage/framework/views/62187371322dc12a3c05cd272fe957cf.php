<?php $__env->startSection('title', 'Gorilla Trekking Uganda 2026 | Bwindi Permits & Packages | Calm Africa Safaris'); ?>
<?php $__env->startSection('meta_description', 'Uganda gorilla trekking from $1,300. Secure your $800 Bwindi permit, choose your sector and trek wild mountain gorillas. Expert guides, guaranteed departures. Book gorilla trekking Uganda today.'); ?>
<?php $__env->startSection('meta_keywords', ', , gorilla trekking Bwindi Impenetrable Forest, Uganda gorilla permits, mountain gorilla trekking Uganda, gorilla trekking packages Uganda, gorilla trekking Rwanda, Mgahinga gorilla trekking, best gorilla trekking Africa, gorilla safari Uganda 2026'); ?>
<?php $__env->startSection('canonical', 'https://calmafricasafaris.com/'); ?>


    
<?php $__env->startSection('twitter_title', 'Gorilla Trekking Uganda 2026 | Bwindi Permits from $800 | Calm Africa Safaris'); ?>
<?php $__env->startSection('og_title', 'Gorilla Trekking Uganda 2026 | Bwindi Impenetrable Forest Packages'); ?>
<?php $__env->startSection('og_description', 'Trek mountain gorillas in Bwindi from $1,300. Permits secured, expert guides, all-inclusive packages. Uganda\'s most trusted gorilla trekking specialist.'); ?>
    

<?php $__env->startSection('og_title', 'Uganda Safari Tours & Gorilla Trekking 2026 | Calm Africa Safaris'); ?>
<?php $__env->startSection('og_description', 'Gorilla trekking, chimp tracking, Big Five safaris and more. Budget to luxury packages from $1,300. Book with East Africa\'s trusted safari operator.'); ?>
    ...
    <div class="hero-carousel absolute inset-0 overflow-hidden rounded-b-none">
        ...
        <div class="hero-slide absolute inset-0 w-full h-full opacity-100 transition-opacity duration-1000 ease-in-out"
            ...
            <div class="hero-bg-layer absolute inset-0"
                 style="background-image:linear-gradient(rgba(0,0,0,.45),rgba(0,0,0,.45)),url('<?php echo e(asset('images/BWINDI.jpg')); ?>');
        ...
        <div class="hero-slide absolute inset-0 w-full h-full opacity-0 transition-opacity duration-1000 ease-in-out"
            ...
            <div class="hero-bg-layer absolute inset-0"
                 style="background-image:linear-gradient(rgba(0,0,0,.45),rgba(0,0,0,.45)),url('<?php echo e(asset('images/BIG FIVE.jpg')); ?>');
                        background-size:cover;
                        background-position:center;
                        background-attachment:fixed;">
            </div>
        ...
        <div class="hero-slide absolute inset-0 w-full h-full opacity-0 transition-opacity duration-1000 ease-in-out"
            ...
            <div class="hero-bg-layer absolute inset-0"
                 style="background-image:linear-gradient(rgba(0,0,0,.45),rgba(0,0,0,.45)),url('<?php echo e(asset('images/home.jpg')); ?>');
                        background-size:cover;
                        background-position:center;
                        background-attachment:fixed;">
            </div>
...
<section id="introduction" class="py-10 sm:py-16 lg:py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
       ...
       Uganda Gorilla Trekking Packages in  Bwindi Impenetrable Forest &amp; Mgahinga
        ...
        <?php echo $__env->make('partials.about-safari', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
</section>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\safaris\resources\views/index.blade.php ENDPATH**/ ?>