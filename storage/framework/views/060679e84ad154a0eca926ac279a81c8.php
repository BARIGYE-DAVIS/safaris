...
<section class="bg-gray-50 py-12 lg:py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-8 sm:mb-12">
            ...
            <p class="text-base sm:text-lg text-gray-600">Discover more amazing safari experiences similar to <?php echo e($tour->title); ?></p>
        </div>
...
<section id="booking" class="bg-white py-12 lg:py-16 border-t border-gray-200">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-8 sm:mb-12">
            ...
            <p class="text-base sm:text-xl text-gray-600">Ready to experience <?php echo e($tour->title); ?>? Fill out the form below and we'll get back to you within 24 hours.</p>
        </div>
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\safaris\resources\views/tours/show.blade.php ENDPATH**/ ?>