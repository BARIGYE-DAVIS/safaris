...
public function index(Request $request)
{
    ...
    // --- Build base query ---
    // select('tours.*') MUST come before withCount(), otherwise withCount's
    // itineraries_count subselect gets wiped out by select() replacing the
    // entire columns array.
    ...
    if ($request->filled('sort')) {
        switch ($request->sort) {
            case 'price_low':
                $query->addSelect([
                    'min_price' => TourPrice::selectRaw('MIN(price)')
